...
export const constantsSlice = createSlice({
  ...
  initialState: {
    value: {
      ...
      testimonialsCards: [
        { title: 'مصطفى حمدى', body: 'مستقل مشهور', description: "اكتشفت منصة علمنى مؤخرًا أثناء البحث عن [منتج] معين. لم يكن لديهم فقط العنصر الذي كنت أبحث عنه ، ولكن اختيارهم كان واسعًا ، وكانت الأسعار تنافسية. كان من السهل التنقل في موقع الويب ، وكانت أوصاف المنتج مفيدة ودقيقة." },
