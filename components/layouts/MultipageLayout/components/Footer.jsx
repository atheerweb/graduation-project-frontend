...
const Footer = () => {
    ...
    return (
        <Box sx={{backgroundColor: "rgb(242,242,242)", display: "flex", flexDirection: "column", alignItems: "center", padding: "27px"}}>
            ...
            <Box sx={{maxWidth: "590px", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "20px", margin: "36px 0"}}>
                <Stack direction="row" spacing="23px" justifyContent="center" flexWrap="wrap" sx={{padding: "0 37px"}}>
                    {
                ...
                <Typography sx={{color: "rgb(77, 77, 77)", textAlign: "center"}}>
